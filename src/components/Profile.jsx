      ...
      <div className="px-7 py-7 flex flex-col-reverse md:flex md:flex-row md:items-center md:justify-between pt-3">
        <div className="flex flex-col gap-y-2">
          ...
          <div className="flex items-center text-center md:text-justify justify-center md:justify-normal pt-6">
            <a href={configData.hireMeLink} target="_blank">
              <button
                type="button"
            ...
            <CopyEmailButton />
            <a
              href={configData.resume_link}
              target="_blank"
              rel="noopener noreferrer"
              className="gap-x-1 before:ease relative overflow-hidden border border-[#000000] bg-black text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-black before:opacity-10 before:duration-700 hover:before:-translate-x-40 font-medium rounded-lg text-sm px-2 py-2 text-center inline-flex items-center mr-2 mb-2"
            >
        ...
        <div className="rounded-full p-2 flex items-center justify-center mb-7">
          <div
            className="w-36 h-36 rounded-full cursor-pointer bg-gradient-to-b from-gray-100 to-gray-300 border-2 flex items-center justify-center 
  transition-all duration-500 ease-in-out 
  hover:rotate-[360deg] hover:scale-105 hover:shadow-lg hover:border-purple-300
